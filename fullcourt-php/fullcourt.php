...
class RestAPI {
    ...
    function __construct($auth_id, $auth_token, $url="https://voip.fullcourt.co", $version="v0.1") {
    ...
    public function search_numbers($params=array()) {
        return $this->request('GET', '/AvailableNumbers/', $params);
    }

    ## IncomingPhoneNumbers ##
    public function get_numbers($params=array()) {
        return $this->request('GET', '/IncomingPhoneNumbers/', $params);
    }

    public function rent_number($params=array()) {
        $number = $this->pop($params, "number");
        return $this->request('POST', '/IncomingPhoneNumbers/'.$number.'/');
    }

    public function get_number($params=array()) {
        $number = $this->pop($params, "number");
        return $this->request('GET', '/IncomingPhoneNumbers/'.$number.'/', $params);
    }

    public function modify_application_number($params=array()) {
        $number = $this->pop($params, "number");
        return $this->request('PUT', '/Number/'.$number.'/', $params);
    }
